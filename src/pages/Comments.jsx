...
const Comments = () => {
  ...
  const recomendedCars = filteredCars.filter((car) =>
    choosedCars.includes(car.marka)
  );

  return (
    <>
      {/* breadcrumbs */}
      <Breadcrumbs items={[{ name: "Reyting" }]} />
              ...
              <ul className="grid grid-cols-3 gap-3">
                {recomendedCars.map((car) => {
                  ...
                  return (
                    <li
                      key={car.id}
                      className="flex flex-col gap-1 justify-center items-center bg-white rounded-lg"
                    >
                      <img
                      ...
                      <div className="p-5">
                        ...
                        <div className="flex flex-col items-center">
                          <p>
                            ...
                            {car.averageRate.toFixed(1)}
                          </p>
                          <p>
                            <span className="font-medium">Sharxlar soni:</span>{" "}
                            {car.count}ta
                          </p>
                        </div>
                      </div>
