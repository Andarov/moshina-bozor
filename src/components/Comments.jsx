      ...
      <div className="w-full max-w-base mx-auto px-5">
        <div className="w-full grid grid-cols-1 gap-8 lg:gap-5 lg:grid-cols-2">
          ...
          <div className="w-full space-y-5">
            ...
            <Link className="inline-block bg-teal-400 text-white font-semibold border-2 border-teal-400 px-6 py-2 rounded-md hover:text-teal-400 hover:bg-white transition-all duration-300" to='/form/comment'>Fikr qoldirish</Link>
          </div>
