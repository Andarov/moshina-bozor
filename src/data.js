...
export const comments = [
  {
    ...
    author: "Islombek",
    comment:
      "Sayt juda ajoyib hali moshina olish niyyatim yo'q bo'lsada bugungi kun moshina narxlari bilan tanishib olyabman.",
  },
  {
    id: uuidv4(),
    img: userIcon,
...
export const news = [
  {
    ...
    img: xitoy,
    title:
      "2023 yilda eng ko‘p avtomobilni qaysi davlat eksport qilgani ma’lum bo‘ldi",
    date: "09-01-2024",
  ...
  },
  {
    ...
    img: volga,
    title:
      "Rossiyada “Volga” avtomobilining ehtimoliy dizayni suratlari internetda tarqaldi",
    date: "07-01-2024",
  ...
  },
  {
    ...
    img: gm,
    title:
      "UzAuto Motors avtomobillarni o‘z egalariga topshirishni vaqtincha to‘xtatib turadi",
    date: "04-01-2024",
  ...
  },
  {
    ...
    img: kiaSorento,
    title:
      "“Inomarka”larning faqat dilerlar tomonidan sotilishi tartibi qayta tiklanishi mumkin",
    date: "29-12-2023",
...
const carComments = [
  ...
  },
  {
    ...
    liked: 3,
    comment:
      "Shu paytgacha 10ta moshina mingan bolsam ichida menga eng yoqqani shu boldi",
  },
  {
    id: generateUniqueId(),
    model: "Chevrolet",
...
export const carModels = {
  chevrolet: [
    { id: "lacetti", name: "Lacetti" },
    { id: "cobalt", name: "Cobalt" },
    { id: "malibu", name: "Malibu" },
    { id: "nexia", name: "Nexia" },
    { id: "matiz", name: "Matiz" },
    { id: "gentra", name: "Gentra" },
    { id: "spark", name: "Spark" },
  ...
  bmw: [
    ...
    { id: "x7", name: "X7" },
    { id: "z4", name: "Z4" },
    { id: "series1", name: "1 Series" },
  ],
  mercedes: [
    { id: "aclass", name: "A-Class" },
    { id: "bclass", name: "B-Class" },
  ...
  mitsubishi: [
    ...
    { id: "asx", name: "ASX" },
    { id: "eclipseCross", name: "Eclipse Cross" },
